...
public class TpArbre {
	...
	/**
	 * tailles de la fen̻tre affichant les images
	 */
	private static final int SIZE_X = 1408, SIZE_Y = 350;
	/**
	...
	public static void main(String[] args) {
		try {
			...
			TEXT_COMMANDS[15] = "teste, pour E[i], si deux points sont dans la m̻me feuille";
		...
		if ((firstTreeNumber != -1) && (secondTreeNumber != -1)
			...
			case 15:
				...
				if (imageSet.get(firstTreeNumber).sameLeaf(x1, y1, x2, y2)) {
					System.out.println("points dans la m̻me feuille");
				} else {
