...
public class TestMySet {
	 ...
	 */
	public static boolean compareOurSets(MySet l1, MySet l2) {
	...
	public static MySet readFileToOurSet(String fileName) {
		MySet set = new MySet();
		try {
			InputStream is = null;
	...
	public void testSetCreation() {
		MySet mySet1 = readFileToOurSet("test-desordre.ens");
		MySet mySet2 = readFileToOurSet("f0.ens");
		assertTrue("set creation in disorder", compareOurSets(mySet1, mySet2));
	}

	@Test
	public void testContainment1() {
		MySet mySet = readFileToOurSet("f0.ens");
	...
	public void testSetAddition() throws FileNotFoundException {
		MySet mySet1 = readFileToOurSet("f0.ens");
		InputStream is = new FileInputStream("f1.ens");
		MySet mySet2 = readFileToOurSet("test-u01.ens");
		mySet1.add(is);
		assertTrue("set addition f0 f1", compareOurSets(mySet1, mySet2));
	}
	...
	public void testRemoval1() {
		...
		MySet mySet2 = readFileToOurSet("test-d05.ens");
		assertTrue("deletion sparsity 1", testSparsity(mySet1));
		assertTrue("deletion 1", compareOurSets(mySet1, mySet2));
	}
	...
	public void testRemoval2() {
		...
		assertTrue("deletion 2", compareOurSets(mySet1, mySet2));
	}
	...
	public void testDifference1() {
		MySet mySet1 = readFileToOurSet("f0.ens");
		MySet mySet2 = readFileToOurSet("f3.ens");
		MySet mySet3 = readFileToOurSet("test-d03.ens");
		mySet1.difference(mySet2);
		assertTrue("difference f0 and f3", compareOurSets(mySet1, mySet3));
	}

	@Test
	public void testDifference2() {
		MySet mySet1 = readFileToOurSet("f3.ens");
		MySet mySet2 = readFileToOurSet("f0.ens");
		MySet mySet3 = readFileToOurSet("test-d30.ens");
		mySet1.difference(mySet2);
		assertTrue("difference f3 and f0", compareOurSets(mySet1, mySet3));
	}

	@Test
	public void testDifference3() {
		MySet mySet1 = readFileToOurSet("f0.ens");
		MySet mySet2 = readFileToOurSet("f1.ens");
		MySet mySet3 = readFileToOurSet("test-d01.ens");
		mySet1.difference(mySet2);
		assertTrue("difference f0 and f1", compareOurSets(mySet1, mySet3));
	}
	...
	public void testDifference4() {
		...
		mySet1.difference(mySet2);
		assertTrue("difference 100+300 and 100", compareOurSets(mySet1, mySet3));
	}
	...
	public void testIntersection1() {
		MySet mySet1 = readFileToOurSet("f0.ens");
		MySet mySet2 = readFileToOurSet("f3.ens");
		MySet mySet3 = readFileToOurSet("test-i03.ens");
		mySet1.intersection(mySet2);
		assertTrue("intersection f0 and f3", compareOurSets(mySet1, mySet3));
	}
	...
	public void testIntersection2() {
		...
		MySet mySet3 = readFileToOurSet("test-i03.ens");
		mySet1.intersection(mySet2);
		assertTrue("intersection f3 and f0", compareOurSets(mySet1, mySet3));
	}
	...
	public void testUnion1() {
		MySet mySet1 = readFileToOurSet("f0.ens");
		MySet mySet2 = readFileToOurSet("f3.ens");
		MySet mySet3 = readFileToOurSet("test-u03.ens");
		mySet1.union(mySet2);
		assertTrue("union f0 and f3", compareOurSets(mySet1, mySet3));
	}
	...
	public void testUnion2() {
		...
		MySet mySet3 = readFileToOurSet("test-u03.ens");
		mySet1.union(mySet2);
		assertTrue("union f3 and f0", compareOurSets(mySet1, mySet3));
	}
	...
	public void testUnion3() {
		...
		mySet1.union(mySet2);
		assertTrue("union 100+300 and 100", compareOurSets(mySet1, mySet3));
	}
	...
	public void testUnion4() {
		...
		mySet1.union(mySet2);
		assertTrue("union 100 and 100+301", compareOurSets(mySet1, mySet2));
	}
	...
	public void testUnion5() {
		...
		assertTrue("union f0 and f3 (bis)", compareOurSets(mySet1, mySet3));
	}

	@Test
	public void testSymmetricDifference1() {
		MySet mySet1 = readFileToOurSet("f1.ens");
		MySet mySet2 = readFileToOurSet("f0.ens");
		MySet mySet3 = readFileToOurSet("test-s01.ens");
